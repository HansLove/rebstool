...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className="mx-auto dark:bg-slate-900 bg-slate-200 text-slate-700 dark:text-slate-100 px-4 py-20 font-sans antialiased  md:px-8 lg:px-12">
      <motion.div
              ...
              >
      <div className="relative grid grid-cols-1 md:max-w-7xl mx-auto gap-20 md:grid-cols-2">
        <div>
